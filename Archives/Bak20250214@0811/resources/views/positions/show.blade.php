        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <div class="row">
                        <div class="col-md-2">
                            <a data-toggle="collapse" href="#collapse9">Budget Variances</a>
                        </div>
                        <div class="col-md-10">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            @if ($position->reptoposno=="")
                                Not Assigned
                            @else
                                Directly:  {{$position->reptocomp}} / {{$position->reptoposno}}
                                , {{$position->reptodesc}}
                            @endif
                        </div>
                        <div class="col-md-5">
                            ...
                            @else
                                Indirectly:  {{$position->reptocom2}} / {{$position->reptopos2}}
                                , {{$position->reptodesc2}}
                            @endif
                        </div>
                    </div>
