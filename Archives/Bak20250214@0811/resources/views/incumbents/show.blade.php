            ...
            <table class="table table-condensed">
              ...
              <tr>
                @foreach($viewIncumbentPositionHistory as $VIPH)
                  <tr>
                    <td>
                      <a href={{route('incumbents.show',$incumbent->id)}}?reqcompany={{$VPO->incumbentcompany}}&reqpositioncompany={{$VPO->positioncompany}}&reqpositionposno={{$VPO->positionposno}}&reqincumbenthistoryid={{$VIPH->incumbentid}}>>
