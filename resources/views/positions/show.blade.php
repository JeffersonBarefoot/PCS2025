...
<body>
<main class="mt-6">
    <div class="grid gap-6 lg:grid-cols-3 lg:gap-2">
        <div class="grid gap-6 lg:grid-cols-2 lg:gap-2">
            {{--@dump($request)--}}
                        ...
                        <div class="col">
                            ...
                            <div class="row">
                                <p>
                                    ...
                                    <a class="btn btn-secondary" data-bs-toggle="collapse" href="#PosSection5"
                                       role="button"
                                       aria-expanded="false" aria-controls="collapseExample">
                                        Reports To
                                    </a>
                            ...
                            <div class="row">
                                <p>
                                    ...
                                    <a class="btn btn-secondary" data-bs-toggle="collapse" href="#PosSection6"
                                       role="button"
                                       aria-expanded="false" aria-controls="collapseExample">
                                        Incumbents
                                    </a>
