                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a data-toggle="collapse" href="#collapseRep01">Filter list to
                                                include:</a>
                                        </div>
                                    </div>
                                </h4>
        ...
        <tr>
            <td>
                @if ($position->active=='I')
                    <span class="glyphicon glyphicon-remove" style="color:grey" data-toggle="tooltip"
                          title="Inactive"></span>
                @endif
            </td>
            ...
            <td>
                @if ($position->curstatus=='VACANT')
                    <span class="glyphicon glyphicon-stop" style="color:gainsboro" data-toggle="tooltip"
                          title="Vacant"></span>
                @endif
                @if ($position->curstatus=='PARTIALLY FILLED')
                    <span class="glyphicon glyphicon-stop" style="color:gold" data-toggle="tooltip"
                          title="Paritally Filled"></span>
                @endif
                @if ($position->curstatus=='FILLED')
                    <span class="glyphicon glyphicon-stop" style="color:lime" data-toggle="tooltip"
                          title="Filled"></span>
                @endif
                @if ($position->curstatus=='OVERFILLED')
                    <span class="glyphicon glyphicon-stop" style="color:crimson" data-toggle="tooltip"
                          title="Overfilled"></span>
                @endif
            </td>
